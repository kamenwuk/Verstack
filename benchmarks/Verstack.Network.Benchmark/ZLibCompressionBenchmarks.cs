...
{
    private ZLibPacketCompressor _compressor;
    private ZLibPacketDecompressor _decompressor;
    private byte[] _smallPayload;
    private byte[] _mediumPayload;
    private byte[] _largePayload;
    private byte[] _compressedSmall;
    private byte[] _compressedMedium;
    private byte[] _compressedLarge;
