using Verstack.Tools.DataCompiler;
using Verstack.Shared.Nbt;

string baseDir = AppContext.BaseDirectory;
string solutionRoot = Path.GetFullPath(Path.Combine(baseDir, "..", "..", "..", "..", ".."));
string toolsDir = Path.Combine(solutionRoot, "tools", "Verstack.Tools.DataCompiler");
string inputDir = Path.Combine(toolsDir, "Input");
string outputDir = Path.Combine(solutionRoot, "Verstack.App", "assets");
